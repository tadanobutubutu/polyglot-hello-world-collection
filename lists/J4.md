...
im a dot lol
```
[Source File](../libraries/j/J-4/Jp32)
...
<],
```
[Source File](../libraries/j/J-4/JR)

##### JRuby
```text
puts "Hello World"
```
[Source File](../libraries/j/J-4/JRuby)
...
```
[Source File](../libraries/j/J-4/JSCall)

##### JScript
```text
print("Hello World");
```
[Source File](../libraries/j/J-4/JScript.NET)

##### JSDoc
```text
/** Hello World */
```
[Source File](../libraries/j/J-4/JSDoc)
...
print "Hello, World!"
```
[Source File](../libraries/j/J-4/JSInstruction)
...
```text
 ("print", "Hello World!")
```
[Source File](../libraries/j/J-4/JSON.lang)

##### Jsonnet
```text
std.trace("Hello World", {})
```
[Source File](../libraries/j/J-4/Jsonnet)

##### JsonPath
```text
$.hello
```
[Source File](../libraries/j/J-4/JsonPath)
...
```
[Source File](../libraries/j/J-4/JSONseq)

##### JSX
```text
export default function App() { return <div>Hello World</div>; }
```
[Source File](../libraries/j/J-4/JSX)
...
echo("Hello, world!");
```
[Source File](../libraries/j/J-4/Jug)
...
3 GOTO 0
```
[Source File](../libraries/j/J-4/JUMP)
...
JNE #0, #1
```
[Source File](../libraries/j/J-4/Jumpback)
...
```
[Source File](../libraries/j/J-4/JumpFuck)
...
,?.?!>-<!
```
[Source File](../libraries/j/J-4/Jumplang)
...
def jumpmin_to_jumplang(jm):
  ...
  return jl
```
[Source File](../libraries/j/J-4/Jumpmin)

##### Jungle
```text
write_char "Hello world!";
```
[Source File](../libraries/j/J-4/Jungle)
...
```
[Source File](../libraries/j/J-4/Junk)
...
print("Hello World")
```
[Source File](../libraries/j/J-4/JupyterLab)
...
hello:
    echo Hello World
```
[Source File](../libraries/j/J-4/Just)

##### JUSTIF
```text
~1?.0=_,.$="Hello, World",=2:~2?.1!.0?>.1!.0,._+1,=2:0:0
```
[Source File](../libraries/j/J-4/JUSTIF)

##### Jython
```text
print("Hello World")
```
[Source File](../libraries/j/J-4/Jython)
