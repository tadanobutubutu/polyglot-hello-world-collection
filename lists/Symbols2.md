...
print("Hello World")
```
[Source File](../libraries/symbols/Symbols-2/3dsMax.max)
...
```
[Source File](../libraries/symbols/Symbols-2/420.420)

##### 4dos_batch
```bat
echo Hello world!
```
[Source File](../libraries/symbols/Symbols-2/4dos_batch.bat)

##### 4gl
```4gl
main\n    display \"Hello World\"\nend main\n
```
[Source File](../libraries/symbols/Symbols-2/4gl.4gl)

##### 4test
```
testcase printHelloWorld()\n    print(\"Hello World\")\n
```
[Source File](../libraries/symbols/Symbols-2/4test)

##### 4th Dimension
```4dd
OPEN WINDOW (10;45;500;330;0;\"Hello Window\")\nWhile (True)\n  MESSAGE (\"Hello World\")\nEnd while\n
```
[Source File](../libraries/symbols/Symbols-2/4th Dimension.4dd)

##### 6969 Assembler
```
MOV C*::Hello World\n
```
[Source File](../libraries/symbols/Symbols-2/6969 Assembler)

##### 8th
```8th
print "Hello World"
```
[Source File](../libraries/symbols/Symbols-2/8th.8th)

##### 8th
```
\"Hello World\\n\" .\n
```
[Source File](../libraries/symbols/Symbols-2/8th)
