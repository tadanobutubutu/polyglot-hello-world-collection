...
Print("Hello World")
```
[Source File](../libraries/h/H-3/Hollywood)
...
"Hello World\n";
```
[Source File](../libraries/h/H-3/HolyC%20TempleOS)
...
(print "Hello World")
```
[Source File](../libraries/h/H-3/Hop%20%20_software)

##### Hope
```text
hello = "Hello World";
```
[Source File](../libraries/h/H-3/Hope)
...
```
[Source File](../libraries/h/H-3/Hopscotch)
